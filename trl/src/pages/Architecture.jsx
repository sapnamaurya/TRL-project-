...
/* MODES (WITH ICONS) */
const modes = [
  { icon: "📋", title: " Questionnaire", desc: "MCQ-based input for initial TRL assessment." },
  { icon: "🛡️", title: "Validation", desc: "Rule/lab-based verification to improve accuracy and reduces subjectivity." },
  { icon: "∑", title: "Mathematical Models", desc: "Fuzzy logic, AHP and Bayesian analysis." },
  { icon: "📈", title: "Simulation", desc: "Monte Carlo-based duration and risk estimation." },
  { icon: "🔗", title: "ERP Integration", desc: "Connects with enterprise systems to evaluate deployment readiness, resource availability, and implementation feasibility." },
  { icon: "🧠", title: "AI Prediction", desc: "AI predicts maturity and timelines." },
];

/* OUTPUTS (WITH ICONS) */
const outputs = [
  { icon: "🎯", title: "TRL Score", desc: "Readiness level 1–9" },
  { icon: "📊", title: "TRL Matrix", desc: "Schedule readiness map" },
  { icon: "📉", title: "Completion Probability", desc: "Probability distribution" },
  { icon: "⚠️", title: "Risk Metrics", desc: "Weighted risk analysis" },
];
...
export default function Architecture() {
  ...
  return (
    <div className="arch-container">
      ...
      {/* HEADER */}
      <div className="arch-header glass">
        <h1>TRL TOOL & PROJECT DURATION ESTIMATION Architecture</h1>
        <p>TRL ranges from 1 (basic principles) to 9 (fully operational system).</p>
